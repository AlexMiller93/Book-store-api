...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            # заведем словари авторов и категорий для проверки на дубликат во время записи в БД
            ...
            for item in json_data:
                ...
                pages_number = check_is_digit(raw_pages_number)
                ...
                for author_name in author_names:
                    ...
                    if author is None:
                        # если данного автора не было в словаре, то создаем объект автора
                ...
                for category_name in category_names:
                    ...
                    if category is None:
                        # если данной категории не было в словаре, то создаем объект категории
